...
import { UserContext, UserContextProvider } from "../pages/pre-built/user-manage/UserContext";
...
import SubjectDetailTabs from "../pages/subjects/SubjectDetailTabs";
import ForgotPasswordCode from "../pages/auth/ConfirmCodeSent";
import SetNewPassword from "../pages/auth/SetNewPassword";
import AssignmentDetailTabs from "../pages/assignments/AssignmentDetailTabs";
import MilestoneList from "../pages/milestones/MilestoneList";
import MilestoneDetailTabs from "../pages/milestones/MilestoneDetailTabs";
import ClassList from "../pages/class-management/ClassList";
import ClassDetail from "../pages/class-management/ClassDetails";
import ClassDetailTabs from "../pages/class-management/ClassDetailTabs";
import Error403Classic from "../pages/error/403-classic";
import RequirementDetail from "../pages/requirements/RequirementDetail";
import StudentEvaluations from "../pages/evaluations/StudentEvaluations";
import SubmissionList from "../pages/submissions/SubmissionList";
import EvaluationTabs from "../pages/evaluations/EvaluationTabs";
import MyClassPage from "../pages/my-class/MyClass";
import RequirementsInClass from "../pages/requirements/RequirementsInClass";
import SubmitDetail from "../pages/submissions/SubmitDetail";
import CouncilList from "../pages/councils/CouncilList";
import SessionList from "../pages/sessions/SessionList";
import Homepage from "../pages/Homepage";
import AnalyticsHomePage from "../pages/Analytics";
import SubjectListTable from "../pages/subjects/SubjectListTable";
import EvaluatedTeamsTabs from "../pages/evaluated-teams/EvaluatedTeamsTabs";
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<AuthGuard element={<Layout />} />}>
        ...
        <Route path="/analytics" element={<AnalyticsHomePage />}></Route>
        ...
        <Route path="/class-list/get-by-id/:id" element={<ClassDetailTabs />}></Route>

        {/* <Route path="/assignment/update/:id" element={<AssignmentDetailTabs />}></Route> */}
        <Route path="/assignment-detail/:id" element={<AssignmentDetailTabs />}></Route>
        {/* <Route path="/assignment/create" element={<AssignmentDetailTabs />}></Route> */}

        <Route path="/milestone-list" element={<MilestoneList />}></Route>
        <Route path="/milestone-list/milestone-details/:id" element={<MilestoneDetailTabs />}></Route>

        <Route path="/requirement-details" element={<RequirementDetail />} />

        <Route path="/dash-board" element={<Dashboard />} />

        <Route path="/ongoing-evaluations" element={<EvaluationTabs />} />
        <Route path="/evaluation-details" element={<GFEvaluationTabs />} />
        <Route path="/final-results" element={<FinalEvaluationResult />} />

        <Route path="/submissions" element={<SubmissionList />} />
        <Route path="/submissions/submit-detail" element={<SubmitDetail />} />
        <Route path="/requirements" element={<RequirementsInClass />} />

        <Route path="/evaluating-sessions" element={<SessionList />} />
        <Route path="/evaluating-councils" element={<CouncilList />} />
        <Route path="/evaluated-teams" element={<EvaluatedTeamsTabs />} />

        <Route path="/my-classes" element={<MyClassPage />} />
        <Route path="/my-classes/get-by-id/:id" element={<ClassDetailTabs />}></Route>

        <Route element={<UserContextProvider />}>
          <Route path="/user-list" element={<UserListRegular />}></Route>
          <Route path="/user-list-compact" element={<UserListCompact />}></Route>
          <Route path="/user-contact-card" element={<UserContactCard />}></Route>
          <Route path="/user-list/user-details/:userId" element={<UserDetails />}></Route>
        </Route>

        <Route>
          <Route path="/user-profile-notification" element={<UserProfileNotification />}></Route>
          <Route path="/user-profile" element={<UserProfileRegular />}></Route>
      ...
      <Route path={`/`} element={<LayoutNoSidebar />}>
        ...
        <Route path="/forgot-password-code" element={<ForgotPasswordCode />}></Route>
        <Route path="/set-new-password" element={<SetNewPassword />}></Route>

        <Route path="/errors">
          <Route path="403-unauthorized" element={<Error403Classic />}></Route>
